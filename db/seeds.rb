...
user1 = User.create!(username: "brice", email: "brice@gmail.com", password: "123456", address: "Chem. de la Pommeraie 15, 1008 Prilly")
user2 = User.create!(username: "matthieu", email: "matthieu@gmail.com", password: "123456", address: "Rte de la Pale 8, 1026 Denges")
user3 = User.create!(username: "david", email: "david@gmail.com", password: "123456", address: "Chem. des Sablons 13, 1007 Lausanne")
user4 = User.create!(username: "alex", email: "alex@gmail.com", password: "123456", address: "Av. du Temple 61, 1012 Lausanne")
user5 = User.create!(username: "cataline", email: "cataline@gmail.com", password: "123456", address: "Chem. de Montagny 55, 1091 Villette")
user6 = User.create!(username: "momo", email: "momo@gmail.com", password: "123456", address: "Chem. de Vuichardaz 11, 1030 Bussigny")
user7 = User.create!(username: "quentin", email: "quentin@gmail.com", password: "123456", address: "Chem. des Crêts 17, 1209 Genève")
